...
--|																								 |
--|	Sections																		             |
--|		1.	Set paper size to 3.5" for all receipt and barcode printers							 |
--|		2. 	Delete all data from AuditedProductCodes table in VersiRentDB						 |
--|		3.	Create Missing Indexes in VersiRentDB if they do not exist 							 |
--|		4.  Create missing indexes in Datacaster if they do not exist							 |
--|		5.	Perform Reorganize/Reindex on all User Databases									 |
--|		6.  Perform an integrity check on all User Databases									 |
--|		7.  Truncate the transaction log for VersiRentDB  									     |
--|																								 |
--+==============================================================================================+
...
SET @storeid=CAST((SELECT ParameterValueText FROM Params WHERE ParamID=93) AS INT);
...
exec dbo.CloseBusinessDay @storeid,@draweramt,@empid,@ishos,@cashcount
--=============================================
